...
class AddEmployeeAddressWidget extends StatefulWidget {
  const AddEmployeeAddressWidget({Key? key}) : super(key: key);

  @override
  _AddEmployeeAddressWidgetState createState() =>
      _AddEmployeeAddressWidgetState();
}

class _AddEmployeeAddressWidgetState extends State<AddEmployeeAddressWidget>
  ...
  void initState() {
    ...
    enterAddressLine1Controller = TextEditingController();
    houseNoController = TextEditingController();
    enterAddressLine2Controller = TextEditingController();
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      7, 5, 0, 0),
                                  child: TextFormField(
                                    controller: enterAddressLine1Controller,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                              ...
                              Expanded(
                                child: Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      7, 5, 0, 0),
                                  child: TextFormField(
                                    controller: enterAddressLine2Controller,
                                    autofocus: true,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                      labelText: 'Enter Address',
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    adressupdate = await EmployeeDetailsGroup
                                        .addAddressCall
                                        .call(
                                      accessToken: FFAppState().AccessToken,
                                      addressLine1:
                                          enterAddressLine1Controller!.text,
                                      addressLine2:
                                          enterAddressLine2Controller!.text,
                                    ...
                                    if ((adressupdate?.statusCode ?? 200) ==
                                        201) {
